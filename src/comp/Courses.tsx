import {ParagraphItalicStyled, SectionContainer, TitleSection, WrapperCard,} from "./Styles";
...
export const Courses = () => {
    ...
    const showCoursesCard = courses.map((item) => {
        return <MultiActionAreaCard title={item.title} time={item.time} price={item.price}
                                    lessons={item.lesson} image={item.image}/>
    })
