...
export const Footer = () => {
    const footerLinks:footerLink[]=
        [
            ...
            {slug:"/consiliere-pentru-parinti-si-profesori", label:"Consiliere pentru părinți și profesori"},
            {slug:"/cursuri-de-dezvoltare-personala", label:"Cursuri de dezvoltare personala"},
    ...
    const socialMediaLinks:socialMedia[]=[
        {name:"youtube",iconSrc:youtubeIcon,link:"https://www.youtube.com/channel/UC9lqTVh9fYo3L35XeLuBlPw"},

        {name:"facebook",iconSrc:facebookIcon,link:"https://www.facebook.com/people/Profa-de-pove%C8%99ti/100083035877348/"},
        {name:"instagram",iconSrc:instagramIcon,link:"https://www.instagram.com/profadepovesti/"},
        {name:"tiktok",iconSrc:tiktokIcon,link:"https://www.tiktok.com/@profadepovesti"},
        {name:"twitter",iconSrc:twitterIcon,link:"https://twitter.com/ITeachStories?t=KTFzvM7w2Inociouib0Ieg&s=09"}
    ]
