...
export const Footer = () => {
    ...
    const [contentFooterLinks, setContentFooterLinks] = useState({title: '', content: []});
    ...
    const socialMediaIcon = [youtubeIcon, facebookIcon, instagramIcon, tiktokIcon, twitterIcon]
    ...
    const FooterSocialMediaColumn = socialMediaLinks.map((socialMedia, index) => {
        return (
            <StyledFooterSocialMedia key={socialMedia.name} onClick={() => redirectLink(socialMedia.link)} >
